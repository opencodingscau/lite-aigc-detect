...
Figure~\ref{fig:confusion} reports absolute confusion counts for LiteSSM-A at the locked Youden threshold ($0.43$).
...
\caption{Confusion counts for LiteSSM-A at the validation Youden threshold ($0.43$) applied unchanged to ID test and UFD (pooled).
Cells report absolute counts (TN/FP/FN/TP) so that sample scale is visible; color scales are panel-wise.\label{fig:confusion}}
\end{figure}
