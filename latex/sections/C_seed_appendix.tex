\section*{Appendix C. Training-Seed Sensitivity (LiteSSM-A and EfficientNet-B0)}
\label{app:seed}
...
Table~\ref{tab:seed-app} reports per-seed scores and population mean$\pm$std over the three runs.
...
\begin{table}[H]
\caption{Appendix Table~C1. ID and UFD Macro AUC across training seeds 42/43/44 (locked recipe).\label{tab:seed-app}}
