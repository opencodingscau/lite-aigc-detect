...
- [x] Tag `v1.0.0-paper` / `v1.0.0-paper.2` published; `v1.0.0-paper.3.1` in progress
- [ ] Zenodo version DOI for `v1.0.0-paper.3.1` back-filled after GitHub Release archival (concept **10.5281/zenodo.21604044**)
...
- [ ] Data Availability cites `v1.0.0-paper.3.1` + new Zenodo version DOI (concept DOI unchanged)
