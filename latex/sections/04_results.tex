...
By contrast, Panel~B pretrained references remain strong on the same DALL·E subset (UnivFD $\approx$0.969; NPR $\approx$0.990), indicating a protocol/panel gap rather than an absolute undetectability claim.
