...
The manuscript fits *Applied Sciences* because it prioritizes reproducible measurement and practical operating-point selection over claims of state-of-the-art accuracy. The main recommendation is **LiteSSM-A** as the preferred generalization–efficiency operating point in the training-matched panel (UFD Macro 0.718; locked batch-32 throughput 226 images/s), while remaining boundaries are documented explicitly (near-chance DALL·E AUCs; hard bedroom domain; non-universal frequency gains).
