...
\featuredapplication{Compact still-image AIGC screening on GPU servers where parameter count, measured throughput, JPEG stability, and honest cross-generator failure reporting matter more than peak in-distribution accuracy or minimum batch-1 latency alone.}
