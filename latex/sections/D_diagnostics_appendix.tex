...
\begin{figure}[H]
\centering
\includegraphics[width=0.94\textwidth]{figures/fig_dalle_score_diag.png}
\caption{Score distributions on UFD DALL·E versus Glide$_{100,10}$ for LiteSSM-A, EfficientNet-B0, and NPR (ref).
Panel~A real and fake scores overlap on DALL·E but separate on Glide$_{100,10}$; NPR remains separated under a different training paradigm.\label{fig:dalle-diag}}
\end{figure}
...
\caption{Pairwise Cohen's $\kappa$ among Panel~A binary decisions on UFD (pooled)~\cite{cohen1960}.
The gray diagonal denotes self-agreement; off-diagonal blue shading encodes cross-model agreement.
...
Axis tags denote A$\star$=LiteSSM-A, B=LiteSSM-B, Eff=EfficientNet-B0, Freq=LiteFreqNet~v2, Mob=MobileNetV3-S, and Shuf=ShuffleNet-x0.5.
