...
Code, frozen summaries, and hashes are released at \url{https://github.com/opencodingscau/lite-aigc-detect} (tag \texttt{v1.0.0-paper.3.1}) and archived on Zenodo (version DOI \url{https://doi.org/10.5281/zenodo.21643045}). Data Availability lists original dataset providers, license limits on redistributing raw images, manifest hashes, and checkpoint policy.
